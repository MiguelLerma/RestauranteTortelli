...
-- Last modification date: 2017-05-22 17:55:04.232
...
COMMENT ON COLUMN "factura"."tipopago" IS 'Cómo desea pagar el cliente';
...
COMMENT ON COLUMN "pago_factura"."pago_valor_pago" IS 'Llave foránea hace referencia al atributo valorpagado tabla Pago';
...
COMMENT ON CONSTRAINT "pago_factura_pago" ON "pago_factura" IS 'Entidad relación Pago-Factura';
